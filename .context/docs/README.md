...
This folder contains repository's developer documentation. Use it as entry point to understand project, its architecture, how to develop locally, and how to test and ship changes.

---

## What this documentation is for

- **Onboarding**: learn workspace layout and how pieces fit together.
...
## Repository snapshot (what you'll see at root)
...
## How codebase is organized (high level)

This repo is a workspace with at least:
...
- If you add a new guide, add it to **Quick links** list above so it's discoverable.
...
| --- | --- | --- |
| Project Overview | `project-overview.md` | What is this repo? Who is it for? What are the main packages? |
...
| Data Flow & Integrations | `data-flow.md` | How data moves through system and external integrations |

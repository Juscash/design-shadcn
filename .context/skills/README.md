...
### Skills custom (Design System JusCash)

| Skill | Descricao | Fases |
|-------|-----------|-------|
| [Figma Component Intake](./figma-component-intake/SKILL.md) | Coletar especificacao a partir do Figma e confirmar variacoes antes de implementar | P, E |
| [Shadcn Component Authoring](./shadcn-component-authoring/SKILL.md) | Implementar componentes no padrao shadcn do repositorio | E |
| [Showcase Creation](./showcase-creation/SKILL.md) | Criar showcases no Storybook e no app demo | E |

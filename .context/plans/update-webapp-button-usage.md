...
# Atualizar app frontend para usar novo Button Plan

> Atualizar o app frontend (apps/web) para usar as novas variantes e tamanhos do componente Button atualizado, removendo uso de variantes/tamanhos obsoletos e adicionando exemplos das novas funcionalidades
...
- **Total symbols discovered:** 4
- **Architecture layers:** Utils, Components
- **Entry points:** packages\ui\src\index.ts, packages\ui\src\components\index.ts, packages\ui\src\components\button\index.ts (+2 more)

### Key Components

**Key Interfaces:**
- `ButtonProps` — C:\projetos\design-shadcn\packages\ui\src\components\button\button.tsx:31
## Agent Lineup
